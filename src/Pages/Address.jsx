...
const Address = () => {
  ...
  const handleSaveAsDefault = (e) => {
    dispatch(toggleSaveAsDefault(e.target.checked));
  };
  ...
  return (
    <div className="address-container">
      <form className="address-form" onSubmit={handleSubmit}>
        ...
        <button className="address-btn" type="submit">Add Address</button> <br /> <br /> <br />
